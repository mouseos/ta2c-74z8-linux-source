...
#define FULL_CV_MIN 99 	//modify by xmtjx to charging parameters
	...
	(long volt, long cur, long iterm, unsigned long cv)
{
	...
	/*add by xmtjx to config charging parameter in kernel --begin--*/
	return ((cur >= 0) && (cur <= iterm) &&
	((volt * 100)  >= (FULL_CV_MIN * cv)));
	/*add by xmtjx to config charging parameter in kernel --end--*/

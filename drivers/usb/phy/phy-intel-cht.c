...
//xmsxm modified @ 2016-08-03, for F1006C dock charging. --start--
#if defined FEATURE_DOCK_USB_INPUT_CURRENT_2A
#define USB_VBUS_DRAW_HIGH	2000
#define USB_VBUS_DRAW_SUPER	2000
#else
#define USB_VBUS_DRAW_HIGH	500
#define USB_VBUS_DRAW_SUPER	900
#endif
//xmsxm modified @ 2016-08-03, for F1006C dock charging. --end--
...
/* xmsxm modify @ 2016-04-14 --start--, to support USB3.0 standard-A connector */
#if defined (FEATURE_HAS_USB3D0_STD_A_CONNECTOR)
	retval = cht_otg_set_id_mux(otg_dev, on);
#endif
/* xmsxm modify @ 2016-04-14 --end--, to support USB3.0 standard-A connector */
...
/*modify by xmtjx to fix USB SDP input current issue  --begin*/
#if 0
	mA = 1500;
#endif
/*modify by xmtjx to fix USB SDP input current issue  --end*/

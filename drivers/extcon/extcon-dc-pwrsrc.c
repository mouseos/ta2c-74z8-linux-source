...
#define DC_XPWR_CHARGE_CUR_SDP_2000	2000  //xmsxm @ 2016-08-03, for F1006C/E dock charging.
...
//xmsxm @ 2016-08-03, for F1006C/E dock charging. -start-
#if defined FEATURE_DOCK_USB_INPUT_CURRENT_2A
			cable_props.ma = DC_XPWR_CHARGE_CUR_SDP_2000;
#else
			cable_props.ma = DC_XPWR_CHARGE_CUR_SDP_500;
#endif
//xmsxm @ 2016-08-03, for F1006C/E dock charging. -end-

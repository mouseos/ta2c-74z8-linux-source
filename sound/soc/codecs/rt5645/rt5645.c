...
#define CONFIG_YF_DET_JACK_BY_CODEC 1
/* #define USE_INT_CLK */
#define JD1_FUNC
//enable drc and eq xmysx@20160107
#define ALC_DRC_FUNC
//enable drc and eq xmysx@20160107 end

//bring up without asrc
#ifndef FEATURE_F1006C
#define USE_ASRC
#endif
/* #define USE_TDM */

//enable adc eq xmysx@20160107
#define USE_ADC_EQ
...
//modify for amic xmys@20160108
	{ RT5645_IN1_IN2	, 0x0040 },/* IN1 boost 20db and signal ended mode *//*boost 0db xmysx@20160113*/
	{RT5645_ADC_BST_VOL1, 0xa000},/*digital boost 24db xmysx@20160113*/
	{ RT5645_REC_L2_MIXER	, 0x0079},/* Mic1 -> RECMIXL */
	{ RT5645_REC_R2_MIXER	, 0x0079},/* Mic1 -> RECMIXR */
#if 0 /* DMIC1 */
...
#ifdef CONFIG_YF_DET_JACK_BY_CODEC
	{ RT5645_MICBIAS	, 0x0008 },
	{ RT5645_CJ_CTRL1	, 0x0021 },
	{ RT5645_CJ_CTRL2	, 0x2827 },
	{ RT5645_CJ_CTRL3	, 0x4000 },
	{ RT5645_JD_CTRL3	, 0x00f0 },//00b0
#else
	{ RT5645_JD_CTRL3	, 0x00b0 },
#endif
#endif
...
//modify for custom project DRC xmysx@20160321
#ifdef FEATURE_MEDION_F1018
	{ RT5645_ALC_DRC_CTRL1  , 0x0000 },
	{ RT5645_ALC_DRC_CTRL2  , 0x011f },
	{ RT5645_ALC_CTRL_2 , 0x1f00 },
	{ RT5645_ALC_CTRL_3 , 0x001f },
	{ RT5645_ALC_CTRL_4 , 0x4207 },
	{ RT5645_ALC_CTRL_1 , 0x0203 },
#elif defined(FEATURE_F1006C)
	{ RT5645_ALC_DRC_CTRL1  , 0x0000 },
	{ RT5645_ALC_DRC_CTRL2  , 0x011f },
	{ RT5645_ALC_CTRL_2 , 0x1f00 },
	{ RT5645_ALC_CTRL_3 , 0x001f },
	{ RT5645_ALC_CTRL_4 , 0x420a },
	{ RT5645_ALC_CTRL_1 , 0x4223 },
#elif defined(FEATURE_F1102A)
	{ RT5645_ALC_DRC_CTRL1  , 0x0000 },
	{ RT5645_ALC_DRC_CTRL2  , 0x001d },
	{ RT5645_ALC_CTRL_2 , 0x1f00 },
	{ RT5645_ALC_CTRL_3 , 0x001f },
	{ RT5645_ALC_CTRL_4 , 0x4204 },
	{ RT5645_ALC_CTRL_1 , 0x4223 },
...
#endif
//modify for custom project DRC xmysx@20160321 end
};
...
#ifdef FEATURE_F1102A
	[RT5645_DRC2_CTRL1] = 0x001D,
	[RT5645_DRC2_CTRL2] = 0x0223,
	[RT5645_DRC2_CTRL3] = 0x1f00,
	[RT5645_DRC2_CTRL4] = 0x001f,
	[RT5645_DRC2_CTRL5] = 0x4204,
...
int rt5645_headset_detect(struct snd_soc_codec *codec, int jack_insert)
{
	...
	if (jack_insert) {
		...
		snd_soc_write(codec, RT5645_CJ_CTRL1, 0x1006);

		snd_soc_write(codec, RT5645_JD_CTRL3, 0x00b0);//0x00b0
		...
		snd_soc_dapm_force_enable_pin(&codec->dapm, "JD Power");
		snd_soc_dapm_sync(&codec->dapm);
		snd_soc_write(codec, RT5645_JD_CTRL3, 0x00f0);//0x00b0
		jack_type = 0;
	}
...
int rt5645_check_jd_status(struct snd_soc_codec *codec)
{
	...
	val = snd_soc_read(codec, RT5645_A_JD_CTRL1) & 0x0020;
...
int rt5645_en_button_detect(struct snd_soc_codec *codec)
{
	snd_soc_update_bits(codec, RT5645_GEN_CTRL2, 0x8, 0x8);
	snd_soc_update_bits(codec, RT5645_INT_IRQ_ST, 0x8, 0x8);
	snd_soc_update_bits(codec, RT5645_IL_CMD, 0x40, 0x40);
	snd_soc_read(codec, RT5645_IL_CMD);
...
EXPORT_SYMBOL(rt5645_en_button_detect);
...
static const struct snd_kcontrol_new rt5645_snd_controls[] = {
	...
	SOC_SINGLE("I2S1 Digital Interface Power Control", RT5645_PWR_DIG1, 15, 1, 0),
        SOC_DOUBLE("Analog DAC1 Power Control", RT5645_PWR_DIG1,
		12, 11, 1, 0),
        /* Power Management Control 2 */
	SOC_SINGLE("Power on DAC stereo1 filter", RT5645_PWR_DIG2, 11, 1, 0),
        /* Power Management Control 3 */
	SOC_SINGLE("LOUTMIX Power Control", RT5645_PWR_ANLG1, 12, 1, 0),
	/* Power Management Control 4 */
	SOC_SINGLE("PLL Power Control", RT5645_PWR_ANLG2, 9, 1, 0),
        /* Power Management Control 5 */
	SOC_DOUBLE("HPMIX Power Control", RT5645_PWR_MIXER,
		RT5645_L_HPMIX_PW, RT5645_R_HPMIX_PW, 1, 0),
        SOC_DOUBLE("OUTMIX Power Control", RT5645_PWR_MIXER,
		RT5645_L_OUTMIX_PW, RT5645_R_OUTMIX_PW, 1, 0),
        /*Global Clock Control*/
        SOC_SINGLE("System Clock Source MUX Control", RT5645_GLB_CLK, 14, 3, 0),


	SOC_SINGLE("IN1 Boost Control (BST1)", RT5645_CJ_CTRL1, 12, 8, 0),
	SOC_SINGLE("IN2 Boost Control (BST2)", RT5645_IN1_IN2, 8, 8, 0),
};
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		rt5645_update_eqmode(codec, EQ_CH_DACL, NORMAL);  // spk EQ
		rt5645_update_eqmode(codec, EQ_CH_DACR, NORMAL);  // spk EQ
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		//*xmyxh      //enable drc and eq xmysx@20160107
		#ifdef FEATURE_F1006C
		//EQ
		rt5645_update_eqmode(codec, EQ_CH_DACL, SPK);
		rt5645_update_eqmode(codec, EQ_CH_DACR, SPK);
		//DRC
		snd_soc_update_bits(codec, RT5645_ALC_CTRL_1,
			RT5645_DRC_AGC_P_MASK | RT5645_DRC_AGC_MASK,
			RT5645_DRC_AGC_P_DAC | RT5645_DRC_AGC_EN);
		#endif
		//enable drc and eq xmysx@20160107 end*/
	...
	case SND_SOC_DAPM_PRE_PMD:
		//*xmyxh       //add eq for record xmysx@20160226
		#ifdef FEATURE_F1006C
		...
		snd_soc_update_bits(codec, RT5645_ALC_CTRL_1,
			RT5645_DRC_AGC_P_MASK | RT5645_DRC_AGC_MASK,
			RT5645_DRC_AGC_P_DAC | RT5645_DRC_AGC_DIS);
		#endif
		//enable drc and eq xmysx@20160107 end*/
		snd_soc_update_bits(codec, RT5645_SPK_VOL,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		rt5645_update_eqmode(codec, EQ_CH_ADC, ADC);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		rt5645_update_eqmode(codec, EQ_CH_ADC, NORMAL);
		break;
	...
	const unsigned int freq_out, struct rt5645_pll_code *pll_code)
{
	...
	int k, n = 0, m = 0, red, n_t, m_t, pll_out, in_t, out_t, i;
...
#ifdef JD1_FUNC
		snd_soc_write(codec, RT5645_PWR_ANLG2, 0x0204);
#else
